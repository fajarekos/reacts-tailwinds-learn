...
function Sidebar() {
  return (
    <div className="min-h-screen flex flex-row w-1/5 bg-blue-700">
      <div>
        ...
        <ul className="flex flex-col py-4">
          <li>
            <a href="#" className="flex flex-row items-center h-12 transform hover:translate-x-2 transition-transform ease-in duration-200 text-white hover:text-yellow-700">
